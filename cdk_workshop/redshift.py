...
class RedshiftStack(Stack):
    def __init__(self, scope: Construct, id: str, config: dict, **kwargs) -> None:
        ...
        secret = _sm.Secret.from_secret_name_v2(
            self, "RedshiftSecret", config["secret-name"]
        )
        ...
        ## Redshift Cluster
        redshift_cluster = _redshift.CfnCluster(
            self,
            "RedshiftCluster",
